...
const Sidebar: React.FC<SidebarProps> = ({ teams, activeTeamId, setActiveTeamId, user, allUsers, onLogout, onAddTeam, onJoinTeam, onUpdateTeam }) => {
  ...
  return (
    <div className={`hidden md:flex flex-col ${isCollapsed ? 'w-20' : 'w-64'} bg-slate-900 dark:bg-slate-950 text-slate-400 border-r border-slate-200 dark:border-slate-800 transition-all duration-300 ease-in-out`}>
